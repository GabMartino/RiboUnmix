...
class RiboUnmixMultiDatasetDataModule(pl.LightningDataModule):
    """
    ...
    def _get_flat_dataset_ids(self, dataset_obj) -> np.ndarray:
        ...
        raise AttributeError(
            "RiboUnmixMultiDataset must expose flat_dataset_ids in "
    ...
    def _get_flat_lengths(self, dataset_obj) -> np.ndarray:
        ...
        raise AttributeError(
            "RiboUnmixMultiDataset must expose flat_lengths in deterministic mode."
        )
    ...
    def setup(self, stage=None):
        ...
        self.train_dataset_obj = RiboUnmixMultiDataset(
            data=shared_data,
        ...
        self.val_dataset_obj = RiboUnmixMultiDataset(
            data=shared_data,
            lengths=shared_data["lengths"],
            nt_encoding=self.nt_enc,
            codon_to_aa_encoding=self.c2aa_enc,
        ...
        if has_distinct_prediction_split:
            ...
            self.predict_dataset_obj = RiboUnmixMultiDataset(
